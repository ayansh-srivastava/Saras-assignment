    ...
    <div class="w-full flex items-center justify-center">
        <div :class="containerClasses">
            <div class="absolute left-4 top-1/2 transform -translate-y-1/2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-colors duration-300" fill="none"
                    viewBox="0 0 24 24" :stroke="iconStroke">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
            </div>
            <input v-model="searchQuery" :class="inputClasses" placeholder="Search books..." @input="debounceSearch" />
        </div>
    </div>
</template>
